...
import { FLOAT_REG_EXP } from '../utils/functions';
...
@Component({
  ...
  styleUrls: ['./float-editor.component.scss'],
})
// tslint:disable-next-line: component-class-suffix
export class FloatEditor implements ICellEditorAngularComp, AfterViewInit {
  private params: any;
  public value: number;
  ...
  private isAValidFloatingNumber(valueToTest: string): boolean {
    return FLOAT_REG_EXP.test(valueToTest);
  }
  ...
  private isKeyPressedNumeric(event: any): boolean {
    ...
    return this.isAValidFloatingNumber(currentValue + charStr);
  }
